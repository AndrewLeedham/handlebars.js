...
declare namespace Handlebars {
  ...
  export namespace VM {
      export function checkRevision(compilerInfo: CompilerInfo): void;
      export function template<T = any>(templateSpec: TemplateSpecification, env: typeof Handlebars): HandlebarsTemplateDelegate<T>;
      ...
      export function invokePartial<T = any>(partial: HandlebarsTemplateDelegate<T> | undefined, context: any, options: RuntimeOptions): string | null;
